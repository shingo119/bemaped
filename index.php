    ...
    <!-- 左側のメニューカラム -->
        ...
        <div class="right-culmn">
            ...
            <div class="map-area">
                ...
                <!-- アルファ版の注意事項[START] -->
                <div class="disclaimer" style="width: 460px; position: absolute; bottom: 2%; right: 70%; z-index: 100; background-color: rgba(137,231,215); border-radius: 10px; box-shadow: 2px 2px 6px #959595; font-size: 20px; ">
